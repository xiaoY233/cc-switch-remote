...
| File | Description |
|------|-------------|
| [5.1-config-files.md](./5-faq/5.1-config-files.md) | CC Switch Remote storage, CLI configuration file formats |
...
- Applicable to CC Switch Remote v3.16.0+

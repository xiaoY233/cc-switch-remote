...
Only download CC Switch Remote from **[github.com/xiaoY233/cc-switch-remote](https://github.com/xiaoY233/cc-switch-remote)**, **[GitHub Releases](https://github.com/xiaoY233/cc-switch-remote/releases)**, or the project source repository. Any "CC Switch Remote" site or client that asks for payment, top-ups, or login credentials is not official.
...
The CLI tools managed by CC Switch Remote (Claude Code, Codex, Gemini CLI) require a Node.js environment.
...
1. Visit the [Releases page](https://github.com/xiaoY233/cc-switch-remote/releases)
...
2. Open the DMG, or extract the zip to get `CC Switch Remote.app`
3. Drag it to the Applications folder

### Signed and Notarized

CC Switch Remote for macOS is signed and notarized by Apple. You can install and open it directly — no extra steps needed.
...
After installation, launch CC Switch Remote:

1. The app window displays correctly
2. A CC Switch Remote icon appears in the system tray
3. The app switcher shows enabled managed apps, and you can switch to the target app panel

## Auto Update

CC Switch Remote includes built-in auto-update functionality:
...
- Move `CC Switch Remote.app` to Trash
- Optional: Delete the configuration directory `~/.cc-switch-remote/`

### Linux

- Remove the installed AppImage, extracted archive, or package file you installed from the CC Switch Remote Releases page.
- Optional: delete the configuration directory `~/.cc-switch-remote/`.

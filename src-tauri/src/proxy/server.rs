...
use super::{
    ...
    providers::codex_oauth_auth::CodexOAuthManager,
...
pub struct ProxyState {
    ...
    /// Shared Codex OAuth credential owner for every request path.
...
impl ProxyServer {
    ...
    pub fn new_with_codex_oauth_manager_and_managed_auth_runtime(
        config: ProxyConfig,
        db: Arc<Database>,
        ...
        let failover_manager = Arc::new(FailoverSwitchManager::new_with_dependencies(
            db.clone(),

...
pub(crate) fn responses_to_anthropic_with_web_search_options(
    ...
    responses_to_anthropic_with_options(body, None, hosted_web_search_name, max_web_search_uses)
}

pub(crate) fn responses_to_anthropic_with_options(
    body: Value,
    tool_schema_hints: Option<&AnthropicToolSchemaHints>,
    hosted_web_search_name: Option<&str>,
    max_web_search_uses: Option<u64>,
        ...
        match item_type {
            ...
            "function_call" => {
                ...
                let args_str = item
                    ...
                    .and_then(|a| a.as_str())
                    .unwrap_or("{}");
                let mut input: Value = if args_str.trim().is_empty() {
                    json!({})
                } else {

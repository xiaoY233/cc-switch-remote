...
pub fn run() {
    // 设置 panic hook，在应用崩溃时记录日志到 <app_config_dir>/crash.log（默认 ~/.cc-switch-remote/crash.log）
    ...
    let builder = builder
        ...
        .setup(|app| {
            ...
            #[cfg(any(target_os = "linux", all(debug_assertions, windows)))]
            {
                #[cfg(target_os = "linux")]
                {
                    ...
                    // tauri-plugin-deep-link writes to: ~/.local/share/com.ccswitch.remote/applications/cc-switch-handler.desktop
            ...
            let mut tray_builder = TrayIconBuilder::with_id(tray::TRAY_ID)
                .tooltip("CC Switch Remote") // 鼠标悬停提示
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::remote_list_profiles,
            commands::remote_save_profile,
            commands::remote_delete_profile,
            ...
            commands::remote_list_project_profiles,
            commands::remote_create_project_profile,
            commands::remote_update_project_profile,
            commands::remote_delete_project_profile,
            commands::remote_apply_project_profile,
            commands::remote_clear_current_project_profile,
            commands::remote_get_common_config_snippet,
            commands::remote_set_common_config_snippet,
            commands::remote_update_toml_common_config_snippet,
            commands::remote_extract_common_config_snippet,
            commands::remote_read_omo_local_file,
            ...
            commands::remote_auth_remove_account,
            commands::remote_auth_set_default_account,
            commands::remote_auth_logout,
            commands::remote_get_app_config_dir,
            commands::remote_set_app_config_dir,
            commands::remote_migrate_skill_storage,
            ...
            commands::remote_restore_db_backup,
            commands::remote_rename_db_backup,
            commands::remote_delete_db_backup,
            commands::remote_webdav_test_connection,
            ...
            commands::remote_probe_tool_installations,
            ...
            commands::remote_query_provider_usage,
            ...
            commands::remote_get_usage_summary_by_app,
            commands::remote_get_usage_trends,
            commands::remote_get_provider_stats,
            commands::remote_get_model_stats,
            commands::remote_get_request_logs,
            commands::remote_get_request_detail,
            commands::remote_get_usage_data_sources,
            ...
            commands::remote_set_default_cost_multiplier,
            commands::remote_get_pricing_model_source,
            commands::remote_set_pricing_model_source,
            commands::remote_get_log_config,
            commands::remote_set_log_config,
            commands::remote_import_providers,
            commands::remote_update_providers_sort_order,
            commands::remote_get_universal_providers,
            commands::remote_get_universal_provider,
            commands::remote_upsert_universal_provider,
            commands::remote_delete_universal_provider,
            commands::remote_sync_universal_provider,
            ...
            commands::remote_remove_from_failover_queue,
            commands::remote_get_auto_failover_enabled,
            commands::remote_set_auto_failover_enabled,
            commands::remote_get_routing_provider_health,
            commands::remote_reset_routing_circuit_breaker,
            commands::remote_get_routing_circuit_breaker_config,
            commands::remote_update_routing_circuit_breaker_config,
            commands::remote_get_routing_circuit_breaker_stats,
            commands::remote_update_routing_app_config,
            commands::remote_get_routing_rectifier_config,
            commands::remote_set_routing_rectifier_config,
            commands::remote_get_routing_optimizer_config,
            commands::remote_set_routing_optimizer_config,
            commands::remote_get_routing_global_outbound_proxy,
            commands::remote_set_routing_global_outbound_proxy,
            commands::remote_get_routing_runtime_status,
            commands::remote_start_routing_runtime,
            commands::remote_stop_routing_runtime,
            commands::remote_list_sessions,
            commands::remote_get_session_messages,
            commands::remote_delete_session,
            commands::remote_delete_sessions,
            commands::remote_get_hermes_memory,
            commands::remote_get_hermes_model_config,
            commands::remote_set_hermes_memory,
            commands::remote_get_hermes_memory_limits,
            commands::remote_set_hermes_memory_enabled,
            commands::remote_get_openclaw_default_model,
            commands::remote_set_openclaw_default_model,
            commands::remote_get_openclaw_env,
            commands::remote_set_openclaw_env,
            commands::remote_get_openclaw_tools,
            ...
            commands::remote_toggle_mcp_app,
            commands::remote_import_mcp_from_apps,
            commands::remote_get_prompts,
            commands::remote_upsert_prompt,
            commands::remote_delete_prompt,
            commands::remote_enable_prompt,
            commands::remote_import_prompt_from_file,
            commands::remote_get_current_prompt_file_content,
            commands::remote_get_installed_skills,
            commands::remote_get_skill_backups,
            commands::remote_delete_skill_backup,
            commands::remote_install_skill_unified,
            commands::remote_uninstall_skill_unified,
            commands::remote_restore_skill_backup,
            commands::remote_toggle_skill_app,
            commands::remote_scan_unmanaged_skills,
            commands::remote_import_skills_from_apps,
            commands::remote_discover_available_skills,
            commands::remote_check_skill_updates,
            commands::remote_update_skill,
            commands::remote_get_skill_repos,
            commands::remote_add_skill_repo,
            commands::remote_remove_skill_repo,
            // Provider terminal
...
fn show_migration_error_dialog(app: &tauri::AppHandle, error: &str) -> bool {
    ...
    let message = if is_chinese_locale() {
        format!(
            "从旧版本迁移配置时发生错误：\n\n{error}\n\n\
            您的数据尚未丢失，旧配置文件仍然保留。\n\
            建议回退到旧版本 CC Switch Remote 以保护数据。\n\n\
            点击「重试」重新尝试迁移\n\
        ...
        format!(
            ...
            Consider rolling back to an older CC Switch Remote version.\n\n\
